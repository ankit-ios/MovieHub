//
//  MHColorPickerViewController.swift
//  SwiftColorPicker
//
...
protocol MHColorPickerDelegate {
...
class MHColorPickerViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    
    // create color picker delegate
    var colorPickerDelegate : MHColorPickerDelegate?
